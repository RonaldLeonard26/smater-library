import { Students } from '../../components/hooks/useLoans';
...
export default function StudentsInfoCard(props: PropsTypes) {
  ...
  return (
    <div className="border rounded-sm p-3 bg-teal-50 border-teal-200">
      ...
      <p className="text-sm text-slate-500">
        Kuota Pinjam : <span className="font-bold">{remainingSlots}</span>
      </p>
    </div>
  );
}
